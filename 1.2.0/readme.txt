...
Donate link: http://konceptus.net/donate
...
http://konceptus.net/wp-hide-post
...
1. Closup showing the *Visibility Attributes* for posts. [See Larger Version](http://konceptus.net/wp-content/uploads/screenshot-11.png)
2. A small panel will appear whenever you are editing or creating a **post**. You can check one or more of the *Visibility Attributes* as needed. [See Larger Version](http://konceptus.net/wp-content/uploads/screenshot-21.png)
3. Closup showing the *Visibility Attributes* for pages. [See Larger Version](http://konceptus.net/wp-content/uploads/screenshot-31.png)
4. Another panel will appear whenever you are editing or creating a new **page**. You can check one or more of the *Visibility Attributes* as needed. Note that options for pages are different from those of posts. [See Larger Version](http://konceptus.net/wp-content/uploads/screenshot-41.png)
...
Please visit the plugin page at [An Apple a Day](http://konceptus.net/wp-hide-post/), and feel free to leave feedback, bug reports and comments.
